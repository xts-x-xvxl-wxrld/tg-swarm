...
5. Write an operator-facing summary, then append the machine-readable plan.

# Note on Account Availability

You do not have access to live account data in this phase. Produce a plan using placeholder account identifiers (e.g., `account_senior_1`, `account_standard_1`) and note where live account roster data would change specific assignments.
